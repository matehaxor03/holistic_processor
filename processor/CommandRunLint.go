...
func commandRunLint(processor *Processor, request *json.Map, response_queue_result *json.Map) []error {
...
func commandRunLintFunc() *func(processor *Processor, request *json.Map, response_queue_result *json.Map) []error {
	funcValue := commandRunLint
	return &funcValue
}