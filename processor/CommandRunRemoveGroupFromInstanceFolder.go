...
func commandRunRemoveGroupFromInstanceFolder(processor *Processor, request *json.Map, response_queue_result *json.Map) []error {
...
func commandRunRemoveGroupFromInstanceFolderFunc() *func(processor *Processor, request *json.Map, response_queue_result *json.Map) []error {
	funcValue := commandRunRemoveGroupFromInstanceFolder
	return &funcValue
}