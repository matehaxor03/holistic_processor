...
func commandRunAssignGroupToUserFunc() *func(processor *Processor, request *json.Map, response_queue_result *json.Map) []error {
	funcValue := commandRunAssignGroupToUser
	return &funcValue
}