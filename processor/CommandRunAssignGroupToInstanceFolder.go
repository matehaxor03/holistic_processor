...
func commandRunAssignGroupToInstanceFolder(processor *Processor, request *json.Map, response_queue_result *json.Map) []error {
	...
	fmt.Println("todo: run assigned group to instance folder")
...
func commandRunAssignGroupToInstanceFolderFunc() *func(processor *Processor, request *json.Map, response_queue_result *json.Map) []error {
	funcValue := commandRunAssignGroupToInstanceFolder
	return &funcValue
}